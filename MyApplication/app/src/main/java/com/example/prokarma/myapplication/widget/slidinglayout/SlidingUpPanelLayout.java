package com.example.prokarma.myapplication.widget.slidinglayout;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            if (ta != null) {
                ...
                mSlideState = PanelState.values()[ta.getInt(R.styleable.SlidingUpPanelLayout_InitialState,
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child == mMainView) {
                ...
                // See https://github.com//AndroidSlidingUpPanel/issues/412.
                height -= lp.topMargin;
            }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        // Fix for : CollapsingToolBar layout
        return (mDragHelper.shouldInterceptTouchEvent(ev) && mSlideState == PanelState.DRAGGING) ||
